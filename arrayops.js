const inventors = [
  ...
  // Array.prototype.filter()
    ...
    const fifteens = inventors.filter(inv =>{
        if(inv.year >=1500 & inv.year <1600) return true;
    })
...
// Array.prototype.reduce()
    ...
    const sumofages = inventors.reduce((total,inv)=> {return total+(inv.passed-inv.year)},0)
